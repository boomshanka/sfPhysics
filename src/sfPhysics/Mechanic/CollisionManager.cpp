...
#include <sfPhysics/Mechanic/CollisionManager.hpp>
...
{
	std::cerr<<event.first->ToLocal(event.Collisionpoint).x*50.f<<" "<<event.first->ToLocal(event.Collisionpoint).y*50.f<<"\n";
