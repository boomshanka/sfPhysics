...
#include <sfPhysics/Mechanic/ShapeManager.hpp>
#include <sfPhysics/Mechanic/Physicable.hpp>
...
namespace sfp
{
	class Object : public ShapeManager, public Physicable
	{
		...
		public:
			...
			sfp::Vector2f GetImpulse(sfp::Vector2f position, sfp::Vector2f normal = sfp::Vector2f(), sfp::Vector2f speed = sfp::Vector2f());
